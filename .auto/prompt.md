...
- Fixed in the Markdown-reference-local-image iteration: local image reference definitions are treated as attachment metadata, removed from hover display, and explicit reference usages collapse to decoded alt/link text.
