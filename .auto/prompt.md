...
- Fixed in the direct-MIME-alias iteration: direct and source base64 image payloads now accept common MIME metadata aliases before falling back to `data:` URL MIME inference.
