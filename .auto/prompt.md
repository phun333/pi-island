...
- Fixed in the paired-HTML-source iteration: local HTML source display cleanup now consumes an optional immediate closing `</source>` together with the opening local source tag.
