...
- Fixed in the direct-image-url iteration: local/data `image_url` payloads now render as direct attachments and participate in content-hash de-dupe, without fetching remote HTTP URLs.
