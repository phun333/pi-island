...
- Fixed in the direct-data-URL iteration: direct and source base64 image payloads now infer image MIME from `data:` URLs when explicit MIME fields are missing, while reusing the existing base64 cleaner/hash path.
