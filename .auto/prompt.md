...
- Fixed in the file-tag-attribute-order iteration: image `<file>` extraction now matches the whole tag first and reads the `name` attribute from the opening tag, independent of attribute order or paired/self-closing form.
