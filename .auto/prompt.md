...
- Fixed in the Markdown-title iteration: Markdown local-image cleanup now allows optional quoted/single-quoted/parenthesized titles between the resolved local path and the closing `)`, replacing the full wrapper with decoded alt/link text.
