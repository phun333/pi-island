...
- Fixed in the Markdown-entity-local-image iteration: Markdown local-image/link display cleanup now decodes common HTML entities in the preserved alt/link label.
