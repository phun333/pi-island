...
- Fixed in the paired-HTML-img iteration: local HTML image display cleanup consumes an optional immediate closing `</img>` tag together with the opening image tag before replacing it with alt text.
