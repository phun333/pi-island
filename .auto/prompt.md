...
- Fixed in the direct-source-url iteration: local/data source URLs now share URL rendering and hash logic with `image_url` payloads, while remote HTTP URLs remain unsupported/no-fetch.
