...
- Fixed in the Markdown-shortcut-reference iteration: after local reference definitions are removed, shortcut reference usages whose label matches a local-image definition collapse to decoded label text.
